...
import {
  ...
  resetReqFriend,
  removeReqFriend
} from "app/action/actionReqFriend";
...
class listRequesFriends extends React.Component {
  ...
  componentDidMount() {
    ...
    io.socket.on(
      "notifi_user_requestFriend" + this.props.auth.user.id,
      function(data) {
                ...
                return (
                  ...
                  >
                    <div className="col-md-3 row">
                      <NavLink to={"/userpage." + reqFriend.username}>
                        <img
                          className="avatar-alert"
                          src={reqFriend.url_avatar}
                        />
                      </NavLink>
                    </div>
                    <div className="user-request">
                      <div style={{ float: "left", width: "45%" }}>
                        ...
                        <NavLink to={"/userpage." + reqFriend.username}>
                          {" "}
                          <strong>{reqFriend.fullname}</strong>
                        </NavLink>
                        <br />
                      ...
                      <div className="pull-right">
                        <button
                          onClick={self.accept.bind(this, reqFriend.username)}
                          className="btn btn-success"
                        >
                          Chấp nhận
                        </button>
                        <button
                          onClick={self.cancel.bind(this, reqFriend.username)}
