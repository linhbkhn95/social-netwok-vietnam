                   ...
                   {/* {data.length>0?data.map((notifi,index)=>{ */}
                       {/* return( */}
                        <div style={{}} className="col-md-12 alert-message">
                              <div className="col-md-3 row"><NavLink to={"/userpage."} ><img className="avatar-alert" src="/images/user/xuan.jpg" /></NavLink></div>
                                <div className="user-request">
                                    <div style={{float:"left",width:"45%"}}> <NavLink to="/userpage.">  <strong>Xuân Nguyễn</strong></NavLink>
                                    <br />
                                    <p className="time-alert">2 bạn chung</p>
                                    </div>
                                    <div className="pull-right">
                                        <button className="btn btn-success">Chấp nhận</button>
                                        <button style={{marginLeft:"3px"}} className="btn btn-default">Từ chối</button>
