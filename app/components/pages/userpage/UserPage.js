  ...
  render() {
    ...
    return (
      ...
      <LayoutPage username={username}>
        ...
        <Route
          path={"/userpage." + username + "/friends"}
          render={function() {
            return (
              <div>
                <ListFriend username={username} />
              </div>
            );
          }}
        />
        ...
        <Route
          path={"/userpage." + username + "/follows"}
          render={function() {
            return (
              <div>
                <ListFollow username={username} />
              </div>
            );
          }}
        />
        ...
        <Route
          path={"/userpage." + username + "/images"}
          render={function() {
            return (
              <div>
                <ListImage username={username} />
              </div>
            );
          }}
        />
