...
class ListFriend extends React.Component {
  ...
  componentDidMount() {
    ...
    let sefl = this;
    if (username) {
      axios.post("/user/getlistFollows", { username }).then(res => {
        if (res.data.EC == 0) {
      ...
      <div style={{ paddingLeft: "0px" }} className="col-md-12 remove-padding-col">
        <div style={{ background: "white" }} className="col-md-12 ">
          ...
          <div style={{ paddingTop: "10px" }} className="row col-md-12">
            {listFollows.map((follow, index) => {
              return (
                <div
                  style={{ display: "" }}
                  className="col-md-6 col-xs-12 item-friend "
                >
                  <div style={{ float: "left" }}>
                    <NavLink to={"/userpage." + follow.user.username}>
                      <img
                        style={{
                          width: "100px",
                          height: "103px",
                    ...
                    <div className="info-user">
                      <Dropdown id="dropdown-custom-1">
                        ...
                        <Dropdown.Menu className="">
                          ...
                          <MenuItem divider />
                          <MenuItem eventKey="3">Đề xuất kết bạn</MenuItem>
                          <MenuItem divider />
