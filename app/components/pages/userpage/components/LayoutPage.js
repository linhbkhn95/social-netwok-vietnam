                                        ...
                                        <div className="bt-info">
                                            <div className="img-left">
                                                <div className="avatar-user">
                                                                       ...
                                                                       {this.props.auth.user.username == this.props.username?
                                                                          <span style={{display:"flex",justifyContent:"center",padding:"3px 7px",fontSize:"11px"}} className=" btn-file">
                                      <i style={{marginRight:"2px"}} className="fa fa-camera" aria-hidden="true"></i> Thay ảnh đại diện
                                      <input onChange={this._handleChange.bind(this)} type="file" /></span>:null} </div>
