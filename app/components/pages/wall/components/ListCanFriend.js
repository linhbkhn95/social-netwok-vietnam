...
class List extends React.Component {
  ...
  componentDidMount() {
    ...
    let sefl = this;
    if (username) {
      io.socket.post("/friends/getCanFriend", {}, resdata => {
        if (resdata.EC == 0) {
  ...
  getTextButton(friend) {
    ...
    if (friend && friend.status == 0)
      ...
      else return "Chấp nhận yêu cầu kết bạn";
              ...
              return (
                ...
                >
                  ...
                  <div className="pull-right">
                    <button
                      onClick={self.accessFriend.bind(
                        this,
                    ...
                    <button
                      onClick={self.cancel.bind(this, friend.user.username)}
                      style={{
                        padding: "3px 12px",
                        fontSize: "11px",
                        marginRight: "3px"
